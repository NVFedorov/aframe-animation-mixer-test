...
AFRAME.registerComponent('gps-camera', {
    ...
    init: function () {
        ...
        this._onGpsEntityPlaceAdded = this._onGpsEntityPlaceAdded.bind(this);
        window.addEventListener('gps-entity-place-added', this._onGpsEntityPlaceAdded, false);
    ...
    _onGpsEntityPlaceAdded: function(event){
...
AFRAME.registerComponent("arrow", {
    ...
    init: function () {
        ...
        let edgeColor = new THREE.Color(0x000000)    

        this.arrow = new CustomArrow(direction.normalize(), new THREE.Vector3(), length, color, edgeColor, headLength, headWidth);
